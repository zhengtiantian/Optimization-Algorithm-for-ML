...
plt.plot(ii1, ff1, color='b', label='y(x) value with gamma=0.5')
plt.plot(ii2, ff2, color='r', label='y(x) value with gamma=1')
plt.plot(ii3, ff3, color='g', label='y(x) value with gamma=2')
