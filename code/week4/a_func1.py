...
# ii, ff, ssx, ssy, xx, yy = RMSProp(1, 1, 100, 0.1, 0.9, 0.0001, [], [], [], [], [], [])
...
ii, ff, ssx, ssy, xx, yy = Adam(10, 1, 100, 0.1, 0.25, 0.9, 0.0001, [], [], [], [], [], [])
# ii1, ff1, ssx1, ssy1, xx1, yy1 = Adam(1, 1, 100, 0.5, 0.25, 0.25, 0.0001, [], [], [], [], [], [])
# ii2, ff2, ssx2, ssy2, xx2, yy2 = Adam(1, 1, 100, 0.2, 0.5, 0.25, 0.0001, [], [], [], [], [], [])
# ii3, ff3, ssx3, ssy3, xx3, yy3 = Adam(1, 1, 100, 0.2, 0.5, 0.5, 0.0001, [], [], [], [], [], [])
# ii4, ff4, ssx4, ssy4, xx4, yy4 = Adam(1, 1, 100, 0.9, 0.9, 0.9, 0.0001, [], [], [], [], [], [])
# ii, ff, ssx, ssy, xx, yy = Adam(1, 1, 200, 0.1, 0.25, 0.25, 0.0001, [], [], [], [], [], [])
# ii1, ff1, ssx1, ssy1, xx1, yy1 = Adam(1, 1, 200, 0.1, 0.9, 0.25, 0.0001, [], [], [], [], [], [])
# ii2, ff2, ssx2, ssy2, xx2, yy2 = Adam(1, 1, 200, 0.1, 0.25, 0.9, 0.0001, [], [], [], [], [], [])
# ii3, ff3, ssx3, ssy3, xx3, yy3 = Adam(1, 1, 100, 0.5, 0.25, 0.25, 0.0001, [], [], [], [], [], [])
# ii4, ff4, ssx4, ssy4, xx4, yy4 = Adam(1, 1, 100, 0.5, 0.9, 0.25, 0.0001, [], [], [], [], [], [])
# ii5, ff5, ssx5, ssy5, xx5, yy5 = Adam(1, 1, 100, 0.5, 0.25, 0.9, 0.0001, [], [], [], [], [], [])
# ii6, ff6, ssx6, ssy6, xx6, yy6 = Adam(1, 1, 200, 0.1, 0.9, 0.9, 0.0001, [], [], [], [], [], [])
# ii7, ff7, ssx7, ssy7, xx7, yy7 = Adam(1, 1, 100, 0.5, 0.9, 0.9, 0.0001, [], [], [], [], [], [])
...
# plt.plot(ii, ff, color='b', label='function value with alpha=0.1,beta1 = 0.25,beta2 = 0.25')
# plt.plot(ii1, ff1, color='r', label='function value with alpha=0.1,beta1 = 0.9,beta2 = 0.25')
# plt.plot(ii2, ff2, color='g', label='function value with alpha=0.1,beta1 = 0.25,beta2 = 0.9')
# plt.plot(ii6, ff6, color='y', label='function value with alpha=0.1,beta1 = 0.9,beta2 = 0.9')
# plt.plot(ii3, ff3, color='b', label='function value with alpha=0.5,beta1 = 0.25,beta2 = 0.25')
# plt.plot(ii4, ff4, color='r', label='function value with alpha=0.5,beta1 = 0.9,beta2 = 0.25')
# plt.plot(ii5, ff5, color='g', label='function value with alpha=0.5,beta1 = 0.25,beta2 = 0.9')
# plt.plot(ii7, ff7, color='y', label='function value with alpha=0.5,beta1 = 0.9,beta2 = 0.9')
